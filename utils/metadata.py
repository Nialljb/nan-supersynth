...
# Fix imports for this gear structure - stub out missing modules
try:
    from interfaces import engine_metadata
except ImportError:
    engine_metadata = None

# Stub out missing utility functions
def MetadataEncoder(obj):
    return obj

def convert_nan_in_dict(d):
    return d
...
if t.TYPE_CHECKING:  # pragma: no cover
    from shared.utils.context import GearToolkitContext  # pylint: disable=unused-import
